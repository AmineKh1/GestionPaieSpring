package com.amine.gestionpaie.utils;
...
public class JwtUtil {
  ...
  public String extractIdSociete(String token) {
    final Claims claims = extractAllClaims(token);

    return claims.get("idSociete", String.class);
  }
  ...
  private String createToken(Map<String, Object> claims,ExtendedUser userDetails) {
    ...
    return Jwts.builder().setClaims(claims)
        ...
        .claim("idSociete", userDetails.getIdSociete().toString())
